...
export class PerfilPage implements OnInit {
  ...
  async modificar(){
    let aux = this.alumno.value
    let usuarioaux = await this.storage.getDato('usuario',this.rut)
    aux.rut = usuarioaux.rut
    aux.correo = usuarioaux.correo
    aux.tipo_usuario = usuarioaux.tipo_usuario
    aux.viaje = usuarioaux.viaje
